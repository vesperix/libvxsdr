...
PYBIND11_MODULE(vxsdr_py, m) {
    ...
    py::class_<vxsdr_py>(m, "vxsdr_py")
        ...
        PYBIND_DEF_ARGS(set_max_payload_bytes, "Set the maximum payload size in bytes for transport to and from the device.", py::arg("max_payload_bytes"))
        ...
        PYBIND_DEF_ARGS(set_tx_enabled, "Enable or disable the transmit RF section.", py::arg("enabled"), py::arg("subdev") = 0)
        PYBIND_DEF_ARGS(set_rx_enabled, "Enable or disable the receive RF section.", py::arg("enabled"), py::arg("subdev") = 0)
        // tuning
        ...
        PYBIND_DEF_ARGS(set_tx_freq, "Set the transmit center frequency.", py::arg("freq"), py::arg("subdev") = 0)
        ...
        PYBIND_DEF_ARGS(set_tx_freq_stage, "Set the center frequency for a transmit tuning stage.", py::arg("freq"), py::arg("stage_num"), py::arg("subdev") = 0)
        PYBIND_DEF_ARGS(set_rx_freq_stage, "Set the center frequency for a receive tuning stage.", py::arg("freq"), py::arg("stage_num"), py::arg("subdev") = 0)
        // gain control
        ...
        PYBIND_DEF_ARGS(set_tx_gain, "Set the gain for a transmit channel.", py::arg("gain"), py::arg("subdev") = 0, py::arg("channel") = 0)
        PYBIND_DEF_ARGS(set_rx_gain, "Set the gain for a receive channel.", py::arg("gain"), py::arg("subdev") = 0, py::arg("channel") = 0)
        ...
        PYBIND_DEF_ARGS(set_tx_gain_stage, "Set the gain for a transmit gain stage.", py::arg("gain"), py::arg("stage_num"), py::arg("subdev") = 0, py::arg("channel") = 0)
        PYBIND_DEF_ARGS(set_rx_gain_stage, "Set the gain for a receive gain stage.", py::arg("gain"), py::arg("stage_num"), py::arg("subdev") = 0, py::arg("channel") = 0)
        // sampling rate
        ...
        PYBIND_DEF_ARGS(get_tx_port_name, "Get the name of a transmit output port.", py::arg("port_num"), py::arg("subdev") = 0, py::arg("channel") = 0)
        PYBIND_DEF_ARGS(get_rx_port_name, "Get the name of a receive input port.", py::arg("port_num"), py::arg("subdev") = 0, py::arg("channel") = 0)
        ...
        PYBIND_DEF_ARGS(set_tx_port, "Set the transmit output port.", py::arg("port_num"), py::arg("subdev") = 0, py::arg("channel") = 0)
        PYBIND_DEF_ARGS(set_rx_port, "Set the receive input port.", py::arg("port_num"), py::arg("subdev") = 0, py::arg("channel") = 0)
        // radio information
        ...
        PYBIND_DEF_ARGS(set_tx_external_lo_enabled, "Enable or disable the transmit external LO input.", py::arg("enabled"), py::arg("subdev") = 0)
        PYBIND_DEF_ARGS(set_rx_external_lo_enabled, "Enable or disable the receive external LO input.", py::arg("enabled"), py::arg("subdev") = 0)
        // digital filters
        ...
        PYBIND_DEF_ARGS(set_tx_filter_coeffs, "Set the transmit frontend FIR filter coefficients.", py::arg("coeffs"), py::arg("subdev") = 0, py::arg("channel") = 0)
        PYBIND_DEF_ARGS(set_rx_filter_coeffs, "Set the receive frontend FIR filter coefficients.", py::arg("coeffs"), py::arg("subdev") = 0, py::arg("channel") = 0)
        // corrections
        ...
        PYBIND_DEF_ARGS(set_tx_iq_bias, "Set the IQ DC bias for a transmit channel to control LO feedthrough.", py::arg("bias"), py::arg("subdev") = 0, py::arg("channel") = 0)
        PYBIND_DEF_ARGS(set_rx_iq_bias, "Set the IQ DC bias for a receive channel to control LO feedthrough.",  py::arg("bias"), py::arg("subdev") = 0, py::arg("channel") = 0)
        ...
        PYBIND_DEF_ARGS(set_tx_iq_corr, "Set the IQ correction for a transmit channel to control image rejection.", py::arg("corr"), py::arg("subdev") = 0, py::arg("channel") = 0)
        ...
        PYBIND_DEF_ARGS(put_tx_data, "Send transmit data to the device.", py::arg("data"), py::arg("n_requested") = 0, py::arg("subdev") = 0, py::arg("timeout") = 10)
            PYBIND_DEF_ARGS(get_rx_data, "Receive data from the device.", py::arg("data"), py::arg("n_requested") = 0, py::arg("subdev") = 0, py::arg("timeout") = 10)
        // host control functions
        PYBIND_DEF_ARGS(set_host_command_timeout, "Set the timeout used by the host for commands sent to the device.", py::arg("timeout"))
