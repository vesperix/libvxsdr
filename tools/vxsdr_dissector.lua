...
local device_cmds = {
    ...
    -- GET_CHANNEL_INFO deleted
    [0x13] = "GET_TIMING_INFO",   -- unimplemented
    [0x14] = "GET_TIMING_STATUS",
    [0x15] = "GET_TIMING_REF",  -- unimplemented
    [0x16] = "SET_TIMING_REF",  -- unimplemented
    [0x17] = "GET_TIMING_RESOLUTION",
...
local radio_cmds = {
    ...
    [0x0E] = "GET_MASTER_CLK",
    [0x0F] = "GET_FILTER_ENABLED",
    [0x10] = "GET_FILTER_COEFFS",
    [0x11] = "SET_RF_FREQ",
    [0x12] = "SET_RF_GAIN",
    [0x13] = "SET_SAMPLE_RATE",
    [0x14] = "SET_RF_BW",  -- unimplemented
    [0x15] = "SET_RF_ENABLED",
    [0x16] = "SET_RF_PORT",
    [0x17] = "SET_RF_PORT_BY_NAME",
    [0x18] = "SET_LO_INPUT", -- unimplemented
    [0x19] = "SET_MASTER_CLK", --unimplemented
    [0x20] = "GET_NUM_SUBDEVS",
    [0x21] = "GET_RF_FREQ_RANGE",
    [0x22] = "GET_RF_GAIN_RANGE",
    [0x23] = "GET_SAMPLE_RATE_RANGE",
    [0x24] = "GET_NUM_CHANNELS",
    [0x25] = "SET_ADC_TEST_PATTERN",
    [0x26] = "GET_FILTER_LENGTH",
    [0x27] = "GET_IQ_BIAS",
    [0x28] = "GET_IQ_CORR",
    [0x29] = "SET_IQ_BIAS",
    [0x2A] = "SET_IQ_CORR",
    [0x2B] = "SET_FILTER_ENABLED",
    [0x2C] = "SET_FILTER_COEFFS"
}
