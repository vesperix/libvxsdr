...
local radio_cmds = {
    ...
    [0x14] = "SET_RF_ENABLED",
    [0x15] = "SET_RF_PORT",
    [0x16] = "SET_RF_PORT_BY_NAME",
    [0x17] = "SET_LO_INPUT", -- unimplemented
    [0x18] = "SET_MASTER_CLK", --unimplemented
    [0x19] = "GET_NUM_SUBDEVS",
    [0x1A] = "GET_RF_FREQ_RANGE",
    [0x1B] = "GET_RF_GAIN_RANGE",
    [0x1C] = "GET_SAMPLE_RATE_RANGE",
    [0x1D] = "GET_NUM_CHANNELS",
    [0x1E] = "SET_ADC_TEST_PATTERN",
    [0x1F] = "GET_FILTER_LENGTH",
    [0x20] = "GET_IQ_BIAS",
    [0x21] = "GET_IQ_CORR",
    [0x22] = "SET_IQ_BIAS",
    [0x23] = "SET_IQ_CORR",
    [0x24] = "SET_FILTER_ENABLED",
    [0x25] = "SET_FILTER_COEFFS",
    [0x26] = "GET_RF_GAIN_STAGE_NAME",
    [0x27] = "GET_RF_GAIN_RANGE_STAGE",
    [0x28] = "GET_RF_GAIN_STAGE",
    [0x29] = "SET_RF_GAIN_STAGE",
    [0x2A] = "GET_RF_FREQ_STAGE_NAME",
    [0x2B] = "GET_RF_FREQ_RANGE_STAGE",
    [0x2C] = "GET_RF_FREQ_STAGE",
    [0x2D] = "SET_RF_FREQ_STAGE",
    [0x2E] = "GET_CAPABILITIES"
}
